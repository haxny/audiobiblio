...
def create_app() -> FastAPI:
    ...
    # API routers
    from .routers import system, jobs, episodes, targets, ingest, sse as sse_router, jdownloader, catalog, upgrades, dedupe, importer as importer_router, works, segmentation
