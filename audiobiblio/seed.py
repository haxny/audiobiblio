...
STATION_MAP: dict[str, tuple[str, str | None]] = {
    ...
    "CRoRZS": ("Radiozurnal Sport", "https://sport.rozhlas.cz"),
    "CRoRPI": ("Radio Prague International", "https://english.radio.cz"),
    "CRoBrno": ("CRo Brno", "https://brno.rozhlas.cz"),
    "CRoCB": ("CRo Ceske Budejovice", "https://budejovice.rozhlas.cz"),
    "CRoHK": ("CRo Hradec Kralove", "https://hradec.rozhlas.cz"),
    "CRoKV": ("CRo Karlovy Vary", "https://vary.rozhlas.cz"),
    ...
    "CRoRK": ("CRo Region - Stredni Cechy", "https://praha.rozhlas.cz"),
